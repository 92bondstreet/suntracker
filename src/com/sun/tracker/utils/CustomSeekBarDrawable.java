...
public class CustomSeekBarDrawable extends Drawable implements Runnable {
	...
	private static final String TAG = "CustomSeekBarDrawable";
	...
	public CustomSeekBarDrawable (Resources res, boolean labelOnRight) {
